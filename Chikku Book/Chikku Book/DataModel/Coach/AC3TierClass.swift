//
//  AirConditioned3TierClass.swift
...
struct AirConditioned3TierClass:Coach{
    let coachNumber: Int
    ...
    init(coachNumber: Int){
        ...
        self.coachTypeDetails = DBManager.getInstance().getCoachTypeDetails(coachType: .AirConditioned3TierClass)!
