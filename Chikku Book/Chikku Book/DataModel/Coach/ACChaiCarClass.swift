//
//  AirConditionedChaiCarClass.swift
...
struct AirConditionedChaiCarClass:Coach{
    let coachNumber: Int
    ...
    init(coachNumber: Int){
        ...
        self.coachTypeDetails = DBManager.getInstance().getCoachTypeDetails(coachType: .AirConditionedChaiCarClass)!
